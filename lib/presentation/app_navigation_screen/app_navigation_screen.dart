...
class AppNavigationScreen extends StatelessWidget {
                                ...
                                Align(
                                    ...
                                    child: Padding(
                                        ...
                                        child: Text(
                                            ...
                                            textAlign: TextAlign.center,
                                            style: AppStyle
                                                .txtRobotoRegular16Bluegray4001))),
                                Padding(
  ...
  onTapBrowseTopics(BuildContext context) {
  ...
  onTapPodcast(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.podcastScreen);
  }
  ...
  onTapAuthor(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.authorScreen);
  }

  onTapTopic(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.topicScreen);
  }
}
