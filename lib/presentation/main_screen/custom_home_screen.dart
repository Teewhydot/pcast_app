...
class _CustomHomeTranslateState extends State<CustomHomeTranslate>
  ...
  final AppNavigationScreen appNavigationScreen = const AppNavigationScreen();
  ...
  void toggle(AnimationController animationController) =>
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      GestureDetector(
                                                                        ...
                                                                        child: Padding(
                                                                            ...
                                                                            child: Row(children: [
                                                                              CustomImageView(svgPath: ImageConstant.imgEye, height: getSize(16), width: getSize(16)),
                                                                              Padding(padding: getPadding(left: 31), child: Text("Subscribed", overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtRobotoMedium14WhiteA700))
                                                                            ])),
                                                                      ),
                                                                      GestureDetector(
                                                                        onTap:
                                                                        ...
                                                                        child: Padding(
                                                                            padding: getPadding(left: 1, top: 37),
                                                                            child: Row(children: [
                                                                              CustomImageView(svgPath: ImageConstant.imgFavorite, height: getSize(16), width: getSize(16)),
                                                                              Padding(padding: getPadding(left: 31), child: Text("Favourites", overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtRobotoMedium14WhiteA700))
                                                                            ])),
                                                                      ),
                                                                      GestureDetector(
                                                                        onTap:
                                                                        ...
                                                                        child: Padding(
                                                                            ...
                                                                            child: Row(children: [
                                                                              CustomImageView(svgPath: ImageConstant.imgClockBlueGray400, height: getSize(16), width: getSize(16), margin: getMargin(bottom: 1)),
                                                                              Padding(padding: getPadding(left: 31), child: Text("History", overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtRobotoMedium14WhiteA700))
                                                                            ])),
                                                                      ),
                                                                      GestureDetector(
                                                                        onTap:
                                                                        ...
                                                                        child: Padding(
                                                                            padding: getPadding(left: 1, top: 38),
                                                                            child: Row(children: [
                                                                              CustomImageView(svgPath: ImageConstant.imgTicket, height: getSize(16), width: getSize(16), margin: getMargin(bottom: 1)),
                                                                              Padding(padding: getPadding(left: 31), child: Text("Payments", overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtRobotoMedium14WhiteA700))
                                                                            ])),
                                                                      ),
                                                                      GestureDetector(
                                                                        onTap:
                                                                        ...
                                                                        child: Padding(
                                                                            padding: getPadding(left: 1, top: 38),
                                                                            child: Row(children: [
                                                                              CustomImageView(svgPath: ImageConstant.imgCamera, height: getSize(16), width: getSize(16), margin: getMargin(bottom: 1)),
                                                                              Padding(padding: getPadding(left: 31), child: Text("Account settings", overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtRobotoMedium14WhiteA700))
                                                                            ])),
                                                                      ),
                                                                      const Spacer(),
                                                                      GestureDetector(
                                                                        ...
                                                                        child: Container(
                                                                            ...
                                                                            decoration: AppDecoration.fillGray90001.copyWith(borderRadius: BorderRadiusStyle.roundedBorder25),
